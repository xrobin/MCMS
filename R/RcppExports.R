...
#' @export
testCpp <- function(aModel, aVarianceModelAsList, i, scale, shape1, shape2, o_restrict, prior_move_proportion, c_sd, o_sd, o_k_scale) {
    .Call('MCMS_testCpp', PACKAGE = 'MCMS', aModel, aVarianceModelAsList, i, scale, shape1, shape2, o_restrict, prior_move_proportion, c_sd, o_sd, o_k_scale)
}

...
// getPrior_MCMC_Cpp
double getPrior_MCMC_Cpp(const S4& aModel, const List& aVarianceModelAsList, const NumericVector& aC, const List& anO, const double c_prior_sd, const double o_prior_shape1, const double o_prior_shape2, const bool verbose = false);
...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        Rcpp::traits::input_parameter< const double >::type o_prior_shape2(o_prior_shape2SEXP );
        Rcpp::traits::input_parameter< const bool >::type verbose(verboseSEXP );
        double __result = getPrior_MCMC_Cpp(aModel, aVarianceModelAsList, aC, anO, c_prior_sd, o_prior_shape1, o_prior_shape2, verbose);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
